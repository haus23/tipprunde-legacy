  ...
  return (
    <button
      ...
      className={classNames(
        primary
          ? 'border-transparent bg-indigo-600 text-white shadow-sm hover:bg-indigo-700 disabled:bg-indigo-400'
          : 'border-gray-300 bg-white text-gray-700 shadow-sm hover:bg-gray-50 disabled:bg-gray-200 disabled:text-gray-500',
